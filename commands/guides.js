...
const guides = {
    ...
    "pufferfish": new  EmbedBuilder()
      ...
      [Download](https://ci.pufferfish.host/) (dont use Pufferfish Plus. It's for their hosting users only)
